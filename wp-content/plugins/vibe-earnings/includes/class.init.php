	...
	function enqueue_script(){
		...
		$kb=apply_filters('vibe_earnings_script_args',array(
            ...
            'translations'=>array(
                ...
                'date_range'=>_x('Select a Date Range','api call','vibe-earnings'),
                ...
                'pages'=>_x('pages','api call','vibe-earnings'),
                'per_page'=>_x('per page','api call','vibe-earnings'),
                ...
                'commission_balance'=>_x('Balance Earnings ','api call','vibe-earnings'),
                'commission_balance_note'=>_x('Earnings need to be above threshold limit for a payout request.','api call','vibe-earnings'),
                ...
                'total_commission'=>_x('Total Earnings','api call','vibe-earnings'),
                'total_payout'=>_x('Total Payouts','api call','vibe-earnings'),
                'request_payouts'=>_x('Request Payout','api call','vibe-earnings'),
        ...
        if(function_exists('bp_is_user') && bp_is_user() || apply_filters('vibebp_enqueue_profile_script',false)){
            wp_enqueue_script('tabulator',plugins_url('../assets/js/tabulator.min.js',__FILE__),array(),VIBE_EARNINGS_PLUGIN_VERSION,true);
            wp_enqueue_style('tabulator-css',plugins_url('../assets/css/tabulator.min.css',__FILE__),array(),VIBE_EARNINGS_PLUGIN_VERSION);
            ...
            wp_enqueue_script('vibe-earnings',plugins_url('../assets/js/earnings.js',__FILE__),array('wp-element','wp-data','vibe-earnings-chartjs','tabulator'),VIBE_EARNINGS_PLUGIN_VERSION);
