    ...
    <div class="col-md-12">
        ...
        <div id="tax-collapsible" class="in collapse<?=($isReceiptEnabled) ? ' show' : ''; ?>">
            ...
            <div class="content yookassa_self_employed in collapse <?= ($isSelfEmployed) ? 'show' : ''; ?>">
                ...
                <ol>
                    <li>
                        <?= __('В нём должно быть не больше 6 позиций.<br> Позиции — это разные наименования, а не количество товаров.', 'yookassa');?>
                    </li>
                    <li>
                        <?= __('Количество может быть только целым числом, дробные использовать нельзя.<br> Например, 1.5 — не пройдёт, а 2 — пройдёт.', 'yookassa');?>
                    </li>
                </ol>
            </div>
