        ...
        if (strpos( $_SERVER['REQUEST_URI'], 'wp-json') != false){
            ...
            $api_url_list = [
                ...
                'wplms/v2'=>[
                    ...
                    'student\/certificates'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                    ...
                    'instructor\/courses'=>['buddypress/bp-loader.php','vibebp/loader.php','wplms_plugin/loader.php'],
                ...
                'vibeappointments/v1'=>[
                    'favourites'=>['vibe-appointments/loader.php'],
                    'getUserEnrolledServices'=>['vibe-appointments/loader.php'],
                    'getOpenSlots'=>['vibe-appointments/loader.php'],
                ],
                'vibeprojects/v1'=>[
