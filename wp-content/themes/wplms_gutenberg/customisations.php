...
class Wplms_Gutenberg_Theme{
    ...
    function enqueue_scripts(){
        ...
        if(empty(vibe_get_option('default_font'))){
            wp_enqueue_style('default_fonts',get_stylesheet_directory_uri().'/css/default_fonts.css',array(),WPLMS_VERSION);
            ?>
            <style>body{
				font-family:system-ui,-apple-system,"Segoe UI",Roboto Slab,"Helvetica Neue",Arial,"Noto Sans","Liberation Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"
			}</style>
            <?php
        }
    }
